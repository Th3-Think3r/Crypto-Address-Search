...
if wallet.startswith('1') and len(wallet) == 34:
    ...
    print('')
    print('Bitcoin wallets always start with 1s, 3s, or bc1 and have a total of 34 characters in the address')
    print('')
    print('For more information about this address, visit https://blockchain.com/btc/address/' + wallet)
