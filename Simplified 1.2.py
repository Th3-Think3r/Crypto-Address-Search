...
while True:
    ...
    if len(wallet) == 42:
        if wallet.startswith('0x'):
            print('')
            print('Ethereum (ETH), or Ethereum-based token; For more information on this address, visit https://etherscan.io/address/' + wallet)
            print('')
            print('There is a large number of Ethereum-based (ERC) tokens. Visit https://eidoo.io/erc20-tokens-list')
    if len(wallet) == 52:
        if wallet.startswith('F'):
            print('')
            print('Factom (FCT); For more information about this address, visit https://explorer.factom.com/addresses/' + wallet)
    if len(wallet) == 56:
        if wallet.startswith('G'):
            print('')
            print('Stellar (XLM); For more information about this address, visit https://stellarchain.io/address/' + wallet)
    if len(wallet) == 76:
   ...
   # else:
        print('')
        print('Could not determine, please be sure you copied and pasted the entire wallet into prompt before hitting enter.')
        print('')
